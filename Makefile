...
SRC = ft_isspace.c ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c \
	...
	ft_strrev.c ft_putchar_u.c ft_flag.c ft_pc.c ft_s.c ft_c.c ft_o.c ft_x.c \
	ft_u.c ft_p.c ft_d.c ft_un.c extra_1.c loop.c extra_2.c cast.c extra_3.c \
	ft_printf.c

OBJ = ft_isspace.o ft_atoi.o ft_bzero.o ft_isalnum.o ft_isalpha.o \
	...
	ft_putstr.o ft_strcat.o ft_strchr.o ft_strclr.o ft_strcmp.o ft_strcpy.o \
	...
	ft_strrev.o ft_putchar_u.o ft_flag.o ft_pc.o ft_s.o ft_c.o ft_o.o ft_x.o \
	ft_u.o ft_p.o ft_d.o ft_un.o extra_1.o loop.o extra_2.o cast.o extra_3.o \
	ft_printf.o
